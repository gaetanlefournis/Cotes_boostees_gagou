...
from utils.constants import URL_WEPARI_WINAMAX


class RetrieverWinamaxWePari(AbstractRetrieverWePari):
    def __init__(
            self,
            db_database: str,
            db_user: str,
    ...
    def retrieve_data(self, element : WebElement) -> dict:
        ...
        odd = list_td[1].text
        old_odd = list_td[2].text
        date = list_td[4].text.split(" ")[0]
        date = datetime.strptime(date, "%d-%m-%Y").date()
        title = list_td[5].text
