...
class BoostedOddsObject:
    ...
    def __post_init__(self) -> None:
        ...
        self.dictionary = {"website": self.website, "sport": self.sport, "title": self.title, "sub_title": self.sub_title, "date": self.date, "old_odd": self.old_odd, "odd": self.odd, "golden": self.golden}
